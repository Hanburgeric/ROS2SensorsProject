...
#include "ROS2SensorsProjectOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class ROS2SENSORSPROJECT_API AROS2SensorsProjectOffroadCar : public AROS2SensorsProjectPawn
{
	GENERATED_BODY()

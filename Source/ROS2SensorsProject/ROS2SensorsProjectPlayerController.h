...
#include "ROS2SensorsProjectPlayerController.generated.h"

class UInputMappingContext;
class AROS2SensorsProjectPawn;
class UROS2SensorsProjectUI;
 ...
 */
UCLASS(abstract)
class ROS2SENSORSPROJECT_API AROS2SensorsProjectPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AROS2SensorsProjectPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UROS2SensorsProjectUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = UI)
	TObjectPtr<UROS2SensorsProjectUI> VehicleUI;
